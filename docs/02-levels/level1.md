...
![Level 1 のスクリーンショット](../images/screenshots/level1.png)
...
**B1: `104.94.23.12/24`** → B1 の町は `IP AND Mask`

```
104.94.23.12   = 01101000.01011110.00010111.00001100
255.255.255.0  = 11111111.11111111.11111111.00000000
          AND
104.94.23.0    ← B1 の町 (ネットワーク)
```
