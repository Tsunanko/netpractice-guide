...
詳細: [06. ルーティングテーブル — `.0/26` や `.64/26` の数字って何？](01-basics/routing-table.md#よく混乱する-026-や-6426-の数字って何)
...
ぜひ参照してください: [🎬 Level 8 を解く順 (絵で順番に追跡)](02-levels/level8.md#解く順--穴埋めの進め方絵で順番に追跡)
